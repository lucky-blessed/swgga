...
function normaliseEvent(e: any) {
  return {
    ...
    ministry:            e.ministry?.name ?? 'Service',
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <h2 className="font-[family-name:var(--font-heading)] text-2xl font-bold text-[#1A1A1A] mb-4">
            {event.title}
          </h2>
          <div className="flex flex-col gap-2 mb-5">
            ...
            <div className="flex items-center gap-2 text-[#374151] text-sm">
              ...
              <span>{new Date(event.date).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Lagos' })} WAT</span>
            </div>
            {event.location && (
              <div className="flex items-center gap-2 text-[#374151] text-sm">
            ...
            >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div className="flex items-center gap-2.5 text-[#374151] text-sm">
                  ...
                  <span>{eventDate.toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit', timeZone: 'Africa/Lagos' })} WAT</span>
                </div>
                {event.location && (
                  <div className="flex items-center gap-2.5 text-[#374151] text-sm">
                    <div className="w-7 h-7 bg-[#FDF6E3] rounded-lg flex items-center justify-center flex-shrink-0">
