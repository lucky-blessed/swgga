...
import { Eye, EyeOff, Shield, CheckCircle, Check } from 'lucide-react'
  ...
  if (!token) {
    return (
      <div className="text-center space-y-4">
        ...
        <Link href="/admin/forgot-password" className="text-[#B8860B] text-sm hover:underline">
    ...
    return (
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-400 text-sm">
          Your admin password has been reset. Redirecting to sign in...
        </p>
        <Link href="/admin/login" className="inline-block text-sm text-[#B8860B] hover:underline">
          Go to Admin Sign In
        </Link>
      </div>
    )
    ...
    <>
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-xs">Choose a strong password for your admin account</p>
        </div>
      </div>
