          ...
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                If an admin account exists for <span className="text-white">{email}</span>,
            ...
            <>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs">Reset your admin account password</p>
                </div>
              </div>

              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-xs text-gray-400">Admin Email Address</label>
